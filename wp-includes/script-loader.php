...
function wp_default_scripts( &$scripts ) {
	...
	$scripts->add( 'prototype', '//apps.bdimg.com/libs/prototype/1.7.1.0/prototype.js', array(), '1.7.1');
	$scripts->add( 'scriptaculous-root', '//apps.bdimg.com/libs/scriptaculous/1.9.0/scriptaculous.js', array('prototype'), '1.9.0');
